...
def write_steps(instance, logs_steps, instance_id, data_folder):
    ...
    #
    # openpyxl compatibility note:
    # Older versions exposed worksheet.merged_cell_ranges as a list-like object.
    # Newer versions deprecate it and internally store merged ranges as a set,
    # so worksheet.merged_cell_ranges can fail with:
    #   TypeError: 'set' object is not subscriptable
    #
    # Use worksheet.merged_cells.ranges and immediately copy it to a list,
    # because we mutate the sheet by unmerging cells while iterating.
    for cell_range in list(sheet_output.merged_cells.ranges):
