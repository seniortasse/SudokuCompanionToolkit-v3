...
class Instance(list):
    ...
    def grid(self):
        """
        Compatibility shim for normalize_step.py / bridge code.
        This engine represents the grid as a list of rows (self[i1][i2]).
        Expose .grid so callers can use inst.grid[i1][i2] deterministically.
        """
        return self
